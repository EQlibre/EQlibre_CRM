# Generated by Django 5.0.2 on 2024-02-12 00:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('client', '0005_remove_client_description'),
        ('core', '0001_initial'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='client',
            name='address',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='adress_clients', to='core.address'),
        ),
        migrations.AddField(
            model_name='client',
            name='country',
